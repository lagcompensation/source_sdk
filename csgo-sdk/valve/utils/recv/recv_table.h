...
struct recv_prop_t {
	...
	recv_var_proxy_fn get_proxy_fn();
	void set_proxy_fn(recv_var_proxy_fn fn);
	data_table_recv_var_proxy_fn get_data_table_proxy_fn();
...
inline recv_var_proxy_fn recv_prop_t::get_proxy_fn() {
...
inline data_table_recv_var_proxy_fn recv_prop_t::get_data_table_proxy_fn() {
